...
burn_percentage_effect <- effect_both_doc_no3 %>% 
  group_by(response_var, Site, burn_percentage_group) %>% 
...
ggplot(effect_both_doc_no3, aes(burn_percentage_group, Effect_size, color = response_var),
  ...
  scale_x_discrete(expand = c(0.1, 0.1), limits = c("0-5", "6-10", "11-15", "16-20", "21-25", "26-30", "31-35", "36-40",
                                                   "41-45", "46-50", "51-55", "56-60", "66-70", "71-75", "76-80", "86-90",
                                                    "91-95", "96-100")) +
  ylim(-5, 5) +
  theme_bw() +
...
```{r chat GPT}
# Assuming your data frame is named 'df' and the variable on the y-axis is 'y'
library(ggplot2)
