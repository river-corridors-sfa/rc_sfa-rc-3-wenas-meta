...
coords <- meta %>% 
  select(Fire_Name, Lat, Long, number_of_sites, State, group)
...
ggplot() +
  geom_sf(data = us_states, fill = "white", color = "black") +
  geom_sf(data = coordinates, aes(size = number_of_sites, color = Fire_Name)) +
  scale_color_manual(values = c("#666666", "#00AFBB", "#666666", "#1B9E77", "#1B9E77", "#7570B3", "#E7298A", "darkred", "darkred", "darkred", "black", "#A6CEE3", "#1F78B4", "#E31A1C", "#33A02C", "#FB9A99", "#1B9E77")) +
  xlim(-125, -68) +
  ylim(25, 52) +
  theme_map() +
