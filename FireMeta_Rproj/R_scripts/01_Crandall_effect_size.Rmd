...
```{r data prepper}
meta_df <- read_csv(here("inputs", "Studies", "Crandall_et_al_2021", "Crandall_paired_test_et_al_2021.csv"))
...
write.csv(control_impact_fill, here("Output_for_analysis", "01_Crandall_effect_size", "crandall_conc_fill.csv"))
...
write.csv(yearly_mean_site, here("Output_for_analysis", "01_Crandall_effect_size", "crandall_temp_norm.csv"))
...
write.csv(yearly_effect_size_combine_long, here("Output_for_analysis", "01_Crandall_effect_size", "Crandall_effect_size.csv"))


```

```{r - plot to compare}
aggregated_crandall <- read_csv("~/GitHub/rc_sfa-rc-3-wenas-meta/FireMeta_Rproj/Output_for_analysis/aggregated_effect_crandall_4sites.csv")


p <- ggplot(yearly_effect_size_combine_long, aes(Site, Effect_size, shape = response_var, color = "red")) +
  geom_point()
  
p2 <- p +
  geom_point(data = aggregated_crandall, aes(x = Site, y = Effect_size, shape = response_var), color = "blue") +
  theme_bw() +
  geom_hline(yintercept = 0, linewidth = 0.5, color = "black") +
  labs(title = "Red is the paired (new) approach and Blue is the aggregated (old) approach") +
