...
sites <- read_csv(here("inputs", "Studies_Summary", "studies_not_included_in_temporal_study.csv")) %>%
...
updated_sites <- tibble(site = c("site 3"),comid = c(8943613)) # Site 3 in the Oliver paper is supposed to be this COMID: 8943613 

# Control is probably supposed to be COMID: 8943655, but also + 8944047 & + 25078055 for the Oliver paper 
# How to add COMIDs to it? Resolution issue?
