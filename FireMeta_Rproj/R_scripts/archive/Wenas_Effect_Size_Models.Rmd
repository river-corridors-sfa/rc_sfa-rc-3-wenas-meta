...
effect_size_geospatial_fire <- effect_size_geospatial_fire %>% 
  dplyr::select(Study_ID, Fire_name, Fire_year, site, comid, totdasqkm, streamorde, slope, burn_percentage, Climate, Biome, Time_Since_Fire, response_var, Effect_size)

write_csv(effect_size_geospatial_fire, here("Output_for_analysis", "effect_size_geospatial_fire.csv"))
