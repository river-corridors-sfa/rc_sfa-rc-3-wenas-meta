...
The purpose of this script is to check to see if I can pull the watersheds from the Oliver et al paper to get all watershed areas. 
...
sites <- read_csv(here("inputs", "Studies_Summary", "Oliver_lat_long.csv")) %>%
...
updated_sites <- tibble(site = c("Site 1", "Site 2", "Site 3", "Site 4"),comid = c(8943655, 8943617, 8943619, 8943621)) 
...
write.csv(sites_export, here("inputs", "Studies_Summary", "wenas_watershed_lat_long_comids.csv"))
