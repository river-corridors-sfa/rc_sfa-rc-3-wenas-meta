...
count_TSF <- TSF_long %>% 
  count(Study_ID)
sum(count_TSF$n)# 59 watersheds are included in the climate analysis 
...
write_csv(percent_difference, here("Output_for_analysis", "04_Meta_merge_all_studies_effect_size", "TSF_PD_CIs.csv"))
