...
crandall_conc_fill <- read_csv(here("Output_for_analysis", "01_Crandall_effect_size", "crandall_conc_fill.csv")) %>% 
  select(-...1)

abbott_conc_fill <- read_csv(here("Output_for_analysis", "02_Abbott_effect_size", "Abbott_conc_fill.csv")) %>% 
  select(-...1)

rhea_conc_fill <- read_csv(here("Output_for_analysis", "03_Rhea_effect_size", "Rhea_conc_fill.csv")) %>% 
  select(-...1)
