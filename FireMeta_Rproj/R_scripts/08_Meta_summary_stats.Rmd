...
doc <- final_dataset %>% 
  ...
  select(Effect_size, totdasqkm, minelevraw, maxelevsmo, minelevsmo, elevfixed, slope, burn_percentage, Time_Since_Fire) %>% # Only want to do the catchment characteristics
  na.omit()
