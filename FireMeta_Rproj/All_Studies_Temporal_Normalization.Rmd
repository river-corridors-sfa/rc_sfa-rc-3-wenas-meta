...
table(meta_df$Study_ID) # 35 studies 

pre_post <- meta_df %>% 
  filter(`Design (Control/Burn; Pre/Post)` == "Pre_Post") 
table(pre_post$Study_ID) # 5 studies that are pre_post so that brings us to 30 total 
...
# now at 19 total 
# Goodale is a mean of means so that brings us to 18
