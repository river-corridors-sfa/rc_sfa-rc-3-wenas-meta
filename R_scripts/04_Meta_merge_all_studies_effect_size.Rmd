...
```{r}
ES_no_watershed <- read_csv(here("Output_for_analysis", "04_Meta_merge_all_studies_effect_size", "Effect_Size_40days_no_watershed.csv")) %>% select(Study_ID, year, response_var, Effect_size_pair, Effect_size_no_watershed)

ES_orig <- read_csv(here("Output_for_analysis", "04_Meta_merge_all_studies_effect_size", "Effect_Size_40days.csv")) %>% 
  select(Study_ID, year, response_var, Effect_size_pair, Effect_size)
...
comparison_data <- merged_data %>% 
  select(response_var, Effect_size_no_watershed, Effect_size)
