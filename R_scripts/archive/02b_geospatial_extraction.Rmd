...
st_write(site_watersheds, "~/GitHub/rc_sfa-rc-3-wenas-meta/Output_for_analysis/02_geospatial_extraction/watershed_shapefile.shp")

# Test to get individual shape file for each watershed
# Get unique watershed identifiers
outdir <- "~/GitHub/rc_sfa-rc-3-wenas-meta/Output_for_analysis/02_geospatial_extraction/watershed_shapefiles/"
...
write_csv(NLCD_2001_2019, here("Output_for_analysis", "02_geospatial_extraction", 
                            "NLCD_2001_2019.csv"))
...
write_csv(lithology, here("Output_for_analysis", "02_geospatial_extraction", "lithology.csv"))
...
write_csv(forest_lost, here("Output_for_analysis", "02_geospatial_extraction", "forest_lost.csv"))
...
write_csv(burn_percentage, here("Output_for_analysis", "02_geospatial_extraction", "burn_percentage.csv"))
...
write_csv(MAST, here("Output_for_analysis", "02_geospatial_extraction", "stream_temp.csv"))
...
write_csv(stats_go, here("Output_for_analysis", "02_geospatial_extraction", "OM_perm.csv"))
...
write_csv(runoff, here("Output_for_analysis", "02_geospatial_extraction", "runoff.csv"))
...
write_csv(NWetdep, here("Output_for_analysis", "02_geospatial_extraction", "NWetdep_2008.csv"))
...
write_csv(climate, here("Output_for_analysis", "02_geospatial_extraction", "temp_precip.csv"))
...
write_csv(BFI, here("Output_for_analysis", "02_geospatial_extraction", "BFI.csv"))
...
write_csv(random_forest_data, here("Output_for_analysis", "02_geospatial_extraction", "random_forest_data.csv"))

# Merge MTBS severity with the rest of the geospatial data
# random_forest_data <- read_csv(here("Output_for_analysis", "02_geospatial_extraction",
#                                  "random_forest_data.csv")) %>%
#   mutate(Site = str_replace_all(Site, "_", " "))
# 
# MTBS_data <- read_csv(here("Output_for_analysis", "02_geospatial_extraction",
#                                  "MTBS_severity.csv")) %>%
#   mutate(Site = str_replace_all(Site, "_", " "))
# 
# merged_df <- full_join(random_forest_data, MTBS_data)
# 
# write_csv(merged_df, here("Output_for_analysis", "02_geospatial_extraction", "random_forest_data.csv"))
...
#   mutate(Site = str_replace_all(Site, "_", " "))
# 
# NLCD_data <- read_csv(here("Output_for_analysis", "02_geospatial_extraction",
#                                  "NLCD_2001_2019.csv")) %>%
#   mutate(Site = str_replace_all(Site, "_", " "))
# 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_1984_1989, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_1990_1995, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_1996_2001, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_2007_2002, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_2008_2013, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_2014_2017, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_severity_2018, here("Output_for_analysis", "02_geospatial_extraction", 
...
# Export the combined data frame to a CSV file
write_csv(MTBS_all, here("Output_for_analysis", "02_geospatial_extraction", 
                            "MTBS_severity.csv"))
...
# Updated workflow for pulling streamcat data 3/7/2025 from *https://github.com/river-corridors-sfa/Geospatial_variables/blob/main/Example_Code/geospatial_extraction_with_comids_RCSFA_all_sites.Rmd*
...
# need to add each metric manually
  # rckdep = Mean Bedrock Depth - Mean depth (cm) to bedrock of soils (STATSGO within AOI)
df <- sc_get_data(metric ='rckdep',
aoi = 'ws', comid = sites$comid,
showAreaSqKm = TRUE, showPctFull = TRUE)

# Join the mean bedrock depth dataframe with our comids
bedrock <- right_join(df, site_watersheds, by = "comid") %>% 
  select(site, comid, everything()) %>% 
  select(!geometry) %>% 
  rename(Site = site)

# Read in lithology data frame we created earlier to merge the bedrock data in there as well
lithology <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "lithology.csv"))

# Join by site and comid
bedrock <- full_join(bedrock, lithology, by = c("Site", "comid"))

# Write out as the lithology csv
write_csv(bedrock, here("Output_for_analysis", "02_geospatial_extraction", "lithology_2.0.csv"))

```

# I have to rebuild the RF data frame to include the updated bedrock data
```{r}
BFI <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "BFI.csv"))

burn_percentage <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "burn_percentage.csv"))

climate <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "temp_precip.csv"))

forest_lost <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "forest_lost.csv"))

lithology <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "lithology_2.0.csv"))

MAST <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "stream_temp.csv"))

NWetdep <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "NWetdep_2008.csv"))

runoff <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "runoff.csv"))

stats_go <- read_csv(here("Output_for_analysis", "02_geospatial_extraction", "OM_perm.csv"))

# Merge all the watershed characteristic data frames together #
watershed_dfs <- list(BFI, burn_percentage, climate, forest_lost, lithology, MAST, NWetdep, runoff, stats_go)

# Use reduce to successively full_join all data frames
RF_data_intermediate <- reduce(watershed_dfs, full_join, by = c("Site", "comid"))
...
merged_df <- full_join(RF_data_intermediate, MTBS_data)
...
merged_df_2 <- full_join(merged_df, NLCD_data)

write_csv(merged_df_2, here("Output_for_analysis", "02_geospatial_extraction", "random_forest_data_new.csv"))
...
# Export the combined data frame to a CSV file
write_csv(combined_df, here("Output_for_analysis", "02_geospatial_extraction", 
                            "MTBS_severity.csv"))
