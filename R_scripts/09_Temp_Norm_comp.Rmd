...
```{r non-normalized effect size vs. normalized (original) effect size}
...
# Perform the paired t-test for each response_var
results <- long_data %>%
...
# A paired t-test was performed to compare the effect sizes between watershed-influenced and watershed-excluded estimates for dissolved organic carbon (DOC). The analysis revealed a statistically significant difference between the two groups (t = -5.11, df = 43, p < 0.00001), indicating that the mean effect size was significantly lower when watershed influence was excluded. The mean difference was -0.71 (95% CI: -0.99 to -0.43). This suggests that watershed considerations substantially impact the effect sizes for DOC measurements.

# A paired t-test was conducted to compare the effect sizes between watershed-influenced and watershed-excluded estimates for nitrate concentrations. The analysis demonstrated a statistically significant difference between the two groups (t = -2.59, df = 84, p = 0.011), with the mean effect size being lower when watershed influence was excluded. The observed mean difference was -0.29 (95% CI: -0.51 to -0.07). These results suggest that the exclusion of watershed influence has a measurable impact on nitrate effect sizes.

# Non-normalized through time ####
