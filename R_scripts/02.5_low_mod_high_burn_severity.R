...
# ---- 1. Load MTBS Fire Perimeter ----
# Read in moquito fire 
mtbs_perims <- st_read("~/Library/CloudStorage/OneDrive-PNNL/Documents/GitHub/rc_sfa-rc-3-wenas-meta/gis_data/Fire_Perimeters/caldor/mtbs/2021/ca3858612053820210815/caldor_burn_bndy.shp")

# ---- 2. Load MTBS Burn Severity Raster ----
# Download the specific fire bundle from MTBS, then load the *_dnbr6.tif
# Classes: 1=Unburned/Low, 2=Low, 3=Moderate, 4=High, 5=Increased Greenness, 6=NoData/Mask
severity <- rast("~/Library/CloudStorage/OneDrive-PNNL/Documents/GitHub/rc_sfa-rc-3-wenas-meta/gis_data/Fire_Perimeters/caldor/mtbs/2021/ca3858612053820210815/caldor_dnbr.tif")
