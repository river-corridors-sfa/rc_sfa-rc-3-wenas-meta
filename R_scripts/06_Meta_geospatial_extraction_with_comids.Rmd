...
lithology <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "lithology.csv"))

# Join by site and comid
bedrock <- full_join(bedrock, lithology, by = c("Site", "comid"))

# Write out as the lithology csv
write_csv(bedrock, here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "lithology_2.0.csv"))

```

# I have to rebuild the RF data frame to include the updated bedrock data
```{r}
BFI <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "BFI.csv"))

burn_percentage <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "burn_percentage.csv"))

climate <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "temp_precip.csv"))

forest_lost <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "forest_lost.csv"))

lithology <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "lithology_2.0.csv"))

MAST <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "stream_temp.csv"))

NWetdep <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "NWetdep_2008.csv"))

runoff <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "runoff.csv"))

stats_go <- read_csv(here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "OM_perm.csv"))
...
write_csv(merged_df_2, here("Output_for_analysis", "06_Meta_geospatial_extraction_with_comids", "random_forest_data_new.csv"))
