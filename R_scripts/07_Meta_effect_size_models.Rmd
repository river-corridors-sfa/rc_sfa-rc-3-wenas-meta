...
# Check for equal variance
performance::check_heteroscedasticity(doc_sev_mixed) #OK: Error variance appears to be homoscedastic (p = 0.986).
...
summary(doc_sev_mixed) # df: 7.801848, t-value: -3.44, p-value: 0.00916 **
fixef(doc_sev_mixed)
...
# Check for equal variance
performance::check_heteroscedasticity(no3_sev_mixed) #OK:Error variance appears to be homoscedastic (p = 0.962).
...
summary(no3_sev_mixed) # df: 18.366293, t-value: 0.895, p-value: 0.382
fixef(no3_sev_mixed)
...
# Check for equal variance
performance::check_heteroscedasticity(no3_sev_mixed) #OK:Error variance appears to be homoscedastic (p = 0.964).
