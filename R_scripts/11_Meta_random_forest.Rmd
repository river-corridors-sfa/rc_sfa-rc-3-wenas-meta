...
replicate_plot_fi <- function(parameter, analyte){
...
doc_eb <- replicate_plot_fi(doc, "doc")
no3_eb <- replicate_plot_fi(no3, "no3")

# Mutate each column at a time
df <- bind_rows(doc_eb, no3_eb)
